...
const SectionTitle = ({ children, subtitle }: { children: React.ReactNode; subtitle?: string }) => (
  <div className="mb-12 text-center">
    {subtitle && (
      <span className="text-emerald-500 font-display font-semibold text-sm uppercase tracking-widest mb-2 block">
        {subtitle}
      </span>
    )}
...
export default function App() {
  ...
  return (
    <div className="min-h-screen font-sans selection:bg-emerald-500/30 selection:text-emerald-200">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-display font-extrabold leading-[1.1] mb-6 text-gradient">
              Alta performance sem <span className="text-emerald-500">esgotamento.</span>
            </h1>
            ...
            <div className="relative z-10 rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
              <div className="aspect-[4/5] bg-gradient-to-t from-emerald-950/40 to-black relative group">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 glass-card rounded-2xl">
                  <p className="text-xs font-bold text-emerald-400 uppercase tracking-widest mb-1">Psicólogo do Digital</p>
                  <p className="text-lg font-display font-bold">Guilhermy Joseph</p>
                  <p className="text-xs text-gray-400">CRP 12/17648</p>
                </div>
              </div>
            </div>
            <div className="absolute -top-6 -right-6 w-24 h-24 bg-emerald-500/20 blur-2xl rounded-full" />
            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-emerald-500/10 blur-3xl rounded-full" />
          </motion.div>
        </div>
      </header>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-1 md:order-2">
              <span className="text-emerald-500 font-display font-semibold text-sm uppercase tracking-widest mb-4 block">A Solução</span>
              <h2 className="text-4xl md:text-5xl font-display font-bold mb-6 leading-tight">
                Um método desenhado para a <span className="text-emerald-500 italic">sua realidade.</span>
              </h2>
      ...
      {/* About Section */}
      <section id="sobre" className="py-24 bg-emerald-950/10">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="space-y-6 text-gray-400 text-lg leading-relaxed">
              ...
              <div className="flex gap-4 pt-4">
                <a href="#" className="w-12 h-12 rounded-full border border-white/10 flex items-center justify-center hover:bg-emerald-500 hover:border-emerald-500 transition-all">
            ...
            {[
              ...
              <div key={idx} className="p-8 rounded-3xl glass-card border-white/5">
                <div className="flex gap-1 mb-4">
                  {[1, 2, 3, 4, 5].map(i => <Zap key={i} className="w-4 h-4 text-emerald-500 fill-emerald-500" />)}
                </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-display font-bold mb-8">
            Pronto para retomar o <span className="text-emerald-500">controle</span> da sua mente?
          </h2>
      ...
      <footer className="py-12 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 bg-emerald-500 rounded flex items-center justify-center font-display font-extrabold text-black text-[10px]">GJ</div>
